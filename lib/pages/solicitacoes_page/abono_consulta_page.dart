                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      // Retorno: obrigatório se não há batida, opcional se há
                      Expanded(
                        child: _TimeField(
                          label: 'Retorno',
        ...
        children: [
          if (autoCalc) ...[
            _previewRow('Horas trabalhadas',
                _formatMinutes(_workedMinutes), context.palette.textSecondary),
            const SizedBox(height: 4),
            _previewRow('Carga horária',
                _formatMinutes(_workloadMinutes), context.palette.textSecondary),
